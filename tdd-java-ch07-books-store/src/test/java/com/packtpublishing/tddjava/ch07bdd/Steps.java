...
public class Steps {
    ...
    public void beforeStory() {
        if (webDriver == null) {
            PhantomJSDriverService phantomJsService = new PhantomJSDriverService.Builder()
                    .usingPhantomJSExecutable(new File("/home/mc/Programs/phantomjs/bin/phantomjs")).build();
            webDriver = new PhantomJSDriver(phantomJsService, DesiredCapabilities.phantomjs());
